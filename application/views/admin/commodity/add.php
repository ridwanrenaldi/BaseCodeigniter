        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="<?php echo site_url('admin/commodity/add') ?>" class="form-horizontal" method="post">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="text" name="_type_" class="form-control" id="_type_" placeholder="Type" value="<?php echo set_value('_type_'); ?>" required="required" minlength="2" maxlength="50">
                    </div>
                  </div>
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                      <input type="number" name="_price_" class="form-control" id="_price_" placeholder="Price" value="<?php echo set_value('_price_'); ?>" required="required" minlength="1" maxlength="15">
                    </div>
                  </div>
                </div>
                <!-- /.card-body -->
